...
const colorHierarchyMap: Record<IconButtonEmpColor, Record<IconButtonEmpHierarchy, HierarchyStyles>> = {
  purple: {
    ...
    secondary: { base: 'bg-semantic-emphasized-purple-50 text-semantic-emphasized-purple-600',     disabled: 'bg-semantic-emphasized-purple-50 text-semantic-emphasized-purple-200' },
  ...
  blue: {
    ...
    secondary: { base: 'bg-semantic-emphasized-blue-50 text-semantic-emphasized-blue-600',         disabled: 'bg-semantic-emphasized-blue-50 text-semantic-emphasized-blue-200' },
  ...
  orange: {
    ...
    secondary: { base: 'bg-semantic-emphasized-orange-50 text-semantic-emphasized-orange-600',     disabled: 'bg-semantic-emphasized-orange-50 text-semantic-emphasized-orange-200' },
