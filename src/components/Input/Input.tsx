...
export const INPUT_SIZES = ['xLarge', 'large', 'medium', 'small'] as const
export const INPUT_VALIDATIONS = ['default', 'error', 'success'] as const
export const INPUT_LABEL_TYPES = ['none', 'optional', 'asterisk'] as const

export type InputSize = (typeof INPUT_SIZES)[number]
export type InputValidation = (typeof INPUT_VALIDATIONS)[number]
export type InputLabelType = (typeof INPUT_LABEL_TYPES)[number]
...
const fieldVariants = cva(
  'group relative flex items-center w-full overflow-hidden transition-colors duration-fast ease-enter',
  {
    variants: {
      size: {
        xLarge:
          'h-[var(--comp-input-height-xl)] px-[var(--comp-input-px-xl)] gap-[var(--comp-input-gap-xl)] rounded-[var(--comp-input-radius-xl)] typography-18-regular',
        large:
          'h-[var(--comp-input-height-lg)] px-[var(--comp-input-px-lg)] gap-[var(--comp-input-gap-lg)] rounded-[var(--comp-input-radius-lg)] typography-16-regular',
        medium:
          'h-[var(--comp-input-height-md)] px-[var(--comp-input-px-md)] gap-[var(--comp-input-gap-md)] rounded-[var(--comp-input-radius-md)] typography-16-regular',
        small:
          'h-[var(--comp-input-height-sm)] px-[var(--comp-input-px-sm)] gap-[var(--comp-input-gap-sm)] rounded-[var(--comp-input-radius-sm)] typography-14-regular',
      },
    },
    defaultVariants: {
      size: 'medium',
...
const iconSizeMap = {
  xLarge: 'size-[var(--comp-input-icon-xl)]',
  large: 'size-[var(--comp-input-icon-lg)]',
  medium: 'size-[var(--comp-input-icon-md)]',
  small: 'size-[var(--comp-input-icon-sm)]',
} as const
...
export interface InputProps
   ...
   * @default 'none'
   * @see INPUT_LABEL_TYPES
   */
  labelType?: InputLabelType

  /**
   * 인풋 아래 도움 텍스트. validation prop에 따라 스타일이 변경된다.
   * @default undefined
   */
  helperText?: string
  ...
  /**
   * 텍스트 앞(leading)에 표시할 아이콘.
   * @default undefined
   */
  iconLeading?: React.ReactNode

  /**
   * 텍스트 뒤(trailing)에 표시할 아이콘. 유효성 검사 상태에서는 검증 아이콘으로 대체된다.
   * @default undefined
   */
